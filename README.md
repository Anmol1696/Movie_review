...
## Conclusions
+ The accuracy of the classifier is around 80%<br>
...
* However we can increase the effiency by using better pre processing. We could use bi-gram and tri-gram models to better our processed data<br>
